...
public final class AutoTriggerTests {
    ...
    public static void anEventTriggerOpensTheStage(GameTestHelper helper) {
        ...
        StageData data = StageData.get(helper.getLevel());
        ResourceLocation blindness = BuiltInRegistries.MOB_EFFECT.getKey(MobEffects.BLINDNESS);
        try {
            ...
            MinecraftForge.EVENT_BUS.post(new MobEffectEvent.Added(player, null, blindnessEffect, null));
