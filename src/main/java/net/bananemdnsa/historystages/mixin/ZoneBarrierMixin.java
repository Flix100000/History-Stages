 ...
 * of.
 *
 * <p>Wrapped rather than redirected: a redirect owns the call site and would shut out anything
 * else that wants the same one, which is the report behind #127 all over again. Movement is a
 * popular place.
 *
...
public class ZoneBarrierMixin {
    ...
    private List<VoxelShape> historystages$addZoneWalls(Level level, Entity entity, AABB sweep,
        ...
        return ZoneBarrierCollision.add(entity, sweep, original.call(level, entity, sweep));
    }
}
