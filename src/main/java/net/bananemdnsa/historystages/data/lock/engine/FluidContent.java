 ...
 *
 * <p>The one place in the mod that names the fluid capability. Every mod exposes a container's
 * contents through it, so one fluid entry covers the vanilla bucket, every modded bucket and every
 * tank item without a single item id being listed.
 *
