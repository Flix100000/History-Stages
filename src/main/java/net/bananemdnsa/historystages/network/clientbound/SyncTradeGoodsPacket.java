 ...
 */
public record SyncTradeGoodsPacket(List<TradePreview> offers) {

    public static void encode(SyncTradeGoodsPacket msg, FriendlyByteBuf buf) {
    ...
    public static SyncTradeGoodsPacket decode(FriendlyByteBuf buf) {
    ...
    public static void handle(SyncTradeGoodsPacket msg, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> ClientTradeGoods.addFromServer(msg.offers()));
