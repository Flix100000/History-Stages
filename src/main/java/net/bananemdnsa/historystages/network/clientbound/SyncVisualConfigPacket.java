 ...
 */
public record SyncVisualConfigPacket(Map<String, String> values) {

    public static void encode(SyncVisualConfigPacket msg, FriendlyByteBuf buffer) {
    ...
    public static SyncVisualConfigPacket decode(FriendlyByteBuf buffer) {
    ...
    public static void handle(SyncVisualConfigPacket msg, Supplier<NetworkEvent.Context> ctx) {
