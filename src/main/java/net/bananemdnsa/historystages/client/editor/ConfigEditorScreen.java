...
public class ConfigEditorScreen extends Screen {
    ...
    public boolean mouseScrolled(double mouseX, double mouseY, double scrollY) {
        ...
        syncPickerState();
        if (itemPickerOverlay != null) return itemPickerOverlay.mouseScrolled(mouseX, mouseY, scrollY);
    ...
    private final Map<Integer, Anim> rowHover = new HashMap<>();
        ...
        public boolean mouseScrolled(double mouseX, double mouseY, double scrollY) {
            double delta = scrollY;
            syncOverlayState();
            if (itemOverlay != null) return itemOverlay.mouseScrolled(mouseX, mouseY, scrollY);
            scrollOffset = Math.max(0, Math.min(maxScroll, scrollOffset - delta * 16));
            return true;
        }
    ...
    private final Map<Integer, Anim> rowHover = new HashMap<>();
        ...
        public boolean mouseScrolled(double mouseX, double mouseY, double scrollY) {
            double delta = scrollY;
            syncOverlayState();
            if (tagOverlay != null) return tagOverlay.mouseScrolled(mouseX, mouseY, scrollY);
            scrollOffset = Math.max(0, Math.min(maxScroll, scrollOffset - delta * 16));
            return true;
        }
    ...
    private final Map<Integer, Anim> rowHover = new HashMap<>();
        ...
        public boolean mouseScrolled(double mouseX, double mouseY, double scrollY) {
            syncOverlayState();
            if (effectOverlay != null) return effectOverlay.mouseScrolled(mouseX, mouseY, scrollY);
